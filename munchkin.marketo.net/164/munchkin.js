...
(function(l) {
    if (!l.MunchkinTracker) {
        var h = l.document,
            ...
            V = e(l.XMLHttpRequest) && e((new l.XMLHttpRequest).withCredentials),
            s = function(b) {
                var a = null,
                    c;
                if (e(b))
            ...
            G = function(b, a) {
                var c = {},
                    ...
                    f = g.length,
                    h, n, l;
                for (h = 0; h < f; h += 1) n = g[h].split(d), e(n) && 1 < n.length && (l = n.shift(), n = n.join(d),
                    c[s(l)] = s(n));
                return c
            },
            H = function(b) {
            ...
            W = function(b) {
                ...
                var c;
                c = Math.floor(9E4 * Math.random()) + 1E4;
                return b +
                    c
            },
            w = function(b) {
            ...
            k = null,
            m = null,
            X = l.navigator.cookieEnabled || h.hasOwnProperty("cookie") && (0 < h.cookie.length || -1 < (h.cookie = "testcookie=test; max-age=10000").indexOf.call(h.cookie, "testcookie=test;")),
            z = !1,
            A = [],
            L = null,
            Y = function(b, a, c) {
            ...
            P = function(b, a, c, d, e) {
                b = b + a + "&" + I(c) + "&" + I(d);
                f.useBeaconAPI && window.navigator && window.navigator.sendBeacon ? window.navigator.sendBeacon(b) : (c = (new Date).getTime(), e = !e && !f.asyncOnly, 0 === a.indexOf("webevents/visitWebPage?") && (e = !1), V ? Y(b, e, f.clickTime) : (new l.Image(1, 1)).src = b, L = c + f.clickTime)
            },
            Z = function() {
                var b;
                return function(a, c) {
            ...
            x = function(b, a, c, d) {
                ...
                if (z) {
                    ...
                    if (!k && e(m) && (a._mchId = m.id, a._mchTk = m.token, e(f.mkt_tok) && (a.mkt_tok = f.mkt_tok), e(f.wsInfo) && (a._mchWs = f.wsInfo), "clickLink" === b && (a._mchCn = e(f.customName) ? f.customName : ""), a._mchHo = h, a._mchPo = p.port, e(a._mchRu) || (a._mchRu = s(p.pathname)), a._mchPc = l, a._mchVr = "164", e(h) && 0 !== h.length && "file:" !== l))
                        for (g in f.anonymizeIP &&
                            (a.aip = 1), e(f.externalSource) && (a._mchEs = f.externalSource), e(v) && (a._mchEcid = v), n += "?_mchNc=" + (new Date).getTime(), P(f.notifyPrefix, n, a, c, d), f.altIds) f.altIds.hasOwnProperty(g) && (h = f.altIds[g], a._mchId = h, P(f.notifyPrefix.replace(/\w{3}\-\w{3}\-\w{3}\.mktoresp\.com/i, h + ".mktoresp.com"), n, a, c, d))
            ...
            R = function(b) {
                ...
                if (f && !a._mchDone) {
                    ...
                    a === h || a === l || "A" !== a.tagName && "AREA" !== a.tagName ? a = null : (c = a.href.replace(/^\s+|\s+$/g, ""), a = e(c) && 0 < c.length && 0 !== c.indexOf("#") && 0 !== c.indexOf(f + "#") && 0 !== c.indexOf("javascript") && !F(a, "mchNoDecorate") ? a : null);
                    e(a) && !Z(b, a) && (d._mchHr = s(a.href), x("clickLink", d), l.mktoLinkTarget = a.href)
                }
            },
            B = function(b) {
                if (z) {
                    if (null !== m) return m;
                    var a = K(p.hostname, f.domainLevel,
                            f.domainSelectorV2),
                        c = w("_mkto_trk"),
                        d = !1 !== f.httpsOnly;
                    if (e(c.id) || f.cookieAnon || b) {
                        if (c.id = k, e(c.token) || (e(f.visitorToken) && "VISITOR_MKTTOK_REPLACE" !== f.visitorToken ? c.token = f.visitorToken : c.token = W(a)), c.store(f.cookieLifeDays, "/", a, d), d && (c = w("_mkto_trk")), !d || e(c.id)) return m = c, Q(), c
                    } else return null
            ...
            T = function() {
                y && e(t) && D ? window.fetch("https://" + t + "/getCookie?_mchId=" + k + "&_mchTd=" + q, {
                    credentials: "include"
                }).then(function(b) {
                    ...
                    window.console.warn("getCookie failed - ",
                        b);
                ...
                if (!z) {
                    ...
                    if (e(f._ecid)) v = f._ecid;
                        ...
                        if (e(window.Visitor) && e(a)) try {
                            ...
                            if (e(g)) {
                                v =
                                    a + ":" + g.getLocationHint() + ":" + g.getMarketingCloudVisitorID();
                                break a
                            }
                        } catch (k) {}
                        for (var g = RegExp("AMCV_([A-Za-z0-9]+%40AdobeOrg)=([^;]+)", "g"), r, n = []; null !== (r = g.exec(h.cookie));) {
                            var q = decodeURIComponent(r[1]),
                                m;
                            e(a) && q !== a || null === (m = /MCMID(%7C|\|)([^%\|]+)/.exec(r[2])) || (r = /MCAAMLH-[^%\|]+(%7C|\|)([0-9]+)/.exec(r[2]), n.push(q + ":" + (e(r) ? r[2] : "") + ":" + m[2]))
                        }
                        v = n.join(";")
                    }
                    if (e(b)) f.apiOnly || (c._mchCn = e(f.customName) ? f.customName : "", d._mchHa = s(p.hash), d._mchRe = s(h.referrer), d._mchQp = s(p.search.substr(1).replace(/&/g,
                        "__-__")), x("visitWebPage", c, d, !0));
                    else if (!(f.cookieAnon || e(l.Mkto) && e(l.Mkto.formSubmit))) {
                        b = [];
                        c = h.forms;
                        d = c.length;
                        for (m = 0; m < d; m += 1)
                            if (F(c[m], "lpeRegForm"))
                                for (g = c[m].elements, n = g.length, a = 0; a < n; a += 1) "submit" !== g[a].type || F(g[a], "mchNoDecorate") || b.push(g[a]);
            ...
            O = {
                ...
                init: function(b, a) {
                    if (X && e(b) && 0 !== b.length) {
                        ...
                        var c = "",
                            d, g, m;
                        d = H(l.location.toString());
                        var r = null;
                        f.notifyPrefix = p.protocol +
                            "//" + k + ".mktoresp.com/";
                        ...
                        if (!e(f.mkt_tok))
                            if (d = H(h.referrer), e(d.mkt_tok)) f.mkt_tok = d.mkt_tok;
                            else if (e(d.enid) && e(d.type))
                            for (m in d) d.hasOwnProperty(m) && "enid" !== m && "type" !== m && (-1 < m.indexOf("mkt_tok") || -1 < d[m].indexOf("mkt_tok")) && (g = H(m + "=" + d[m]), e(g.mkt_tok) && (f.mkt_tok = g.mkt_tok));
                        if ("preview" !== c || !/\/lpeditor\/preview$/.test(p.pathname)) {
                            ...
                            c = -1 < m.indexOf("safari");
                            m = / version\/([0-9]+.[0-9]+)/.exec(m);
                            ...
                            y && window.fetch ?
                                (D = "true" === window.localStorage.getItem("_mktoSecureLp_" + k), e(t) ? T() : window.fetch(p.protocol + "//" + k + ".mktoutil.com/mktoutil/lpDomain?_mchId=" + k + "&_mchTd=" + q).then(function(a) {
                ...
                munchkinFunction: function(b, a) {
                    ...
                    switch (b) {
                        case "clickLink":
                            ...
                            break;
                        case "visitWebPage":
                            e(a.url) && (c._mchRu = a.url), e(a.params) && (c._mchQp = a.params), e(a.name) && (c._mchCn = a.name), d._mchRe = s(h.referrer), x("visitWebPage", c, d)
                    }
                },
        ...
        u(l, "beforeunload", function() {
            if (l.mktoLinkTarget && (l.mktoLinkTarget.toLowerCase().startsWith("mailto:") || l.mktoLinkTarget.toLowerCase().startsWith("tel:"))) delete l.mktoLinkTarget;
            else {
        ...
        (function(b) {
            var a = !1,
                ...
                d = h.documentElement,
                e = function(c) {
                    "readystatechange" === c.type && "complete" !== h.readyState || a || (a = !0, b.call(l, c.type || c))
                },
                f = null,
                f = function() {
                    try {
            ...
            if ("complete" === h.readyState) b.call(l, "lazy");
            else {
        ...
        l.MunchkinTracker = l.Munchkin = O;
        l.mktoMunchkin = O.init;
        l.mktoMunchkinFunction = O.munchkinFunction
    }
})(window);