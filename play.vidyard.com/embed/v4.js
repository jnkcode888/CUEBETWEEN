var vidyardEmbed = function(e) {
        ...
        M = function() {
            function e(e) {
                ...
                Object.keys(n).forEach(function(e) {
                    t[e] = n[e]
                }), "inline" !== this.type && "lightbox" !== this.type && (v("Invalid Vidyard player embed type, defaulting to inline.", "warn"), this.type = "inline"), this.v = T, this.disable_popouts = 1, this.custom_id = this.custom_id || I("vycustom_id"), this.vyemail = this.vyemail || I("vyemail"), this.vysfid = this.vysfid || I("vysfid"), this.vyetoken = this.vyetoken || I("vyetoken");
                var r = I("vyac"),
                    i = I("vyplayer");
    ...
    function F(e) {
        ...
        for (var t = 0, n = e; t < n.length; t++) {
            ...
            o && (-1 === f(a, window.VidyardV4.preloadLinks) && (q(o, a), window.VidyardV4.preloadLinks.push(a)))
        }
    }
    ...
    var H = function() {
        ...
        G = g(function() {
            window.onVidyardAPI && "function" == typeof window.onVidyardAPI && window.onVidyardAPI(window.VidyardV4), H()
        }),
        J = n(3),
        $ = new(n.n(J).a)({
    ...
    var X, Z = function(e, t) {
        ...
        se = function(e) {
            ...
            if (t && n) {
                ...
                return a.src = "https://" + U() + "/" + t + ".jpg", a.className = "vidyard-player-embed", a.setAttribute("style", c), a.setAttribute("data-uuid", t), a.setAttribute("data-type", i), Object.keys(o).forEach(function(e) {
        ...
        le = function(e) {
            ...
            n.on("sidePlaylistOpen", function() {
                ...
                n.placeholder.parentElement.removeChild(n.placeholder), N(n.placeholder, "inserted", !0), e.appendChild(n.placeholder), a.parentElement.parentElement.style.position = "relative", a.style.opacity = "1"
            }), u.then(function() {
        ...
        je = function(e) {
            return Ne((t = e.querySelectorAll("[data-autofocus-inside]"), he(t).map(function(e) {
                return Ce([e])
            }).reduce(function(e, t) {
                return e.concat(t)
            }, [])));
        ...
        Fe = function(e, t) {
            ...
            if (o[0] || (o = (a = r, ke(Ne(Ce(a)), !1)).filter(function(e) {
                    var t = e.node;
                    return Re(t)
                }))[0]) {
        ...
        De = function(e, t) {
            var n, r = Fe(e, t);
            if (!Be && r) {
                if (qe > 2) return console.error("FocusLock: focus-fighting detected. Only one focus management system could be active. See https://github.com/theKashey/focus-lock/#focus-fighting"), Be = !0, void setTimeout(function() {
                    Be = !1
                }, 1);
                qe++, (n = r.node).focus(), n.contentWindow && n.contentWindow.focus(), qe--
            }
        },
        ze = 0,
        We = null,
        ...
        Ge = function(e) {
            ze = e, e && function() {
                ...
                if (ze) {
                    var t = ze;
                    He() || (t && !we(t) && (e = De(t, We)), We = document.activeElement)
                }
            }()
        },
        Je = [],
    ...
    function Ze(e, t, n) {
            ...
            i = function(e) {
                var t = document.createElement("div"),
                    ...
                    o = function() {
                        ...
                        e.className = "vidyard-close-container", e.setAttribute("aria-label", "Close Player"), e.setAttribute("role", "button"), e.setAttribute("tabindex", "0"), t.className = "vidyard-close-x", document.documentMode < 9 && (t.className += " simple-close", t.innerHTML = "&times;");
        ...
        return a.id = "vidyard-focusable-element", a.tabIndex = 0, i.popbox.appendChild(r.backerElement), i.popbox.appendChild(r.containingDiv), i.popbox.appendChild(o), pe.ios() && de(), document.body.appendChild(i.overlayWrapper), document.body.appendChild(a), i.closeContainer.focus(), Qe.on(i.overlayWrapper), Xe.a.trap(i.overlayWrapper), setTimeout(function() {
    ...
    function et(e) {
        ...
        e.player.showLightbox = function() {
            $.setLevel(e.player.uuid)("show lightbox"),
                function(e) {
                    if (!e.iframe || document.getElementById("vidyard-overlay")) return;
    ...
    function nt(e) {
        ...
        }, 1e3 * L)), X && X.focus(), Object.keys(Ye).forEach(function(e) {
            var t = Ye[e],
                n = t.eventName,
                r = t.handler,
                i = t.element;
    ...
    var ot = function(e) {
        ...
        ut = function(e, t, n) {
            if (void 0 === n && (n = !1), n || t && t.hasBacklink && !at.test(document.location.host)) {
    ...
    var ct = function(e, t) {
        ...
        lt = function() {
            ...
            return e.prototype.on = function(e, t) {
                ...
                v("playChapter() is deprecated. We recommend to use playVideoAtIndex() instead."), this.playVideoAtIndex(e)
                ...
                } else v("Missing arguments. Need eventId")
            }, e.prototype.getCurrentChapter = function() {
                return v("getCurrentChapter() is deprecated. We recommend to use getCurrentVideoIndex() instead."), this.getCurrentVideoIndex()
        ...
        dt = function(e) {
            var t = window.VidyardV4,
                ...
                r = (t.playerReadyListeners, new M(e)),
                i = r.uuid,
                o = $.setLevel(i);
    ...
    function yt(e, t) {
        var n = e.getCurrentVideoIndex(),
            r = function(e, t) {
                if ("object" == typeof pt[e.uuid]) return "object" != typeof ht[e.uuid][t] && vt(e, t), ht[e.uuid][t]
            }(e, n);
        if (void 0 !== r && "object" == typeof r.player.metadata && 0 !== r.thresholds.length) {
            ...
            if (r.lastTimeUpdate = t, !(i <= 0 || i > 1)) {
                ...
                for (var o = r.player.metadata.chapters_attributes[n].video_attributes.length_in_milliseconds, a = Math.floor(o / 1e3), u = r.timeWatched / a * 100; u >= r.thresholds[r.thresholds.length - 1];) r.callback({
                    chapter: n,
    ...
    function mt(e, t, n) {
        ! function(e, t, n) {
            "object" != typeof ht[e.uuid] && (ht[e.uuid] = {}), pt[e.uuid] = {
                callback: t,
        ...
        return e.on("timeupdate", r), {
            ...
            removeEventListeners: function() {
                e.off("timeupdate", r),
                    function(e) {
                        pt[e.uuid] = void 0, ht[e.uuid] = void 0
                    }(e)
            }
        }
    }
            ...
            integrations: new function() {
                ...
                var r = function(e, t) {
                    ...
                    u = function(e, t, n) {
                        ...
                        return v("IntegrationsWatcher.communicateIntegration " + r, "debug"), B(r, "https://" + U(), e.iframe), !0
                    },
                    c = function(t, n, r) {
    ...
    n.d(t, "_debug", function() {
        ...
        return It
    }), s("error", "onerror", _t, window), s("unhandledrejection", "", function(e) {
        var t = e.reason,
            n = e.timeStamp,
            r = e.type;
        e.reason instanceof Error && Et(t.stack) && (e.preventDefault(), _t({
            error: t,
            filename: t.stack,
            message: t.message,
            timeStamp: n,
    ...
    var Ot = wt._debug,
        Ct = wt.api,
        It = wt.players;
    switch (window.VidyardV4 = window.VidyardV4 || wt, window.Vidyard = window.Vidyard || xt, document.readyState) {
        case "complete":
            Ct.renderDOMPlayers();
            break;
        case "interactive":
            F(), s("load", "onload", function() {
