...
(function() {
    ...
    var AITag = new function() {
        ...
        var config = {
            ...
            "trackAsset": true,
            "sCatSgmIndNum": 60,
            "uaEnableOrganizationPush": true,
            "sCatCtaEvNum": 35,
            "requestInterval": 50,
            "barIconFont": "fa-chevron-circle",
            "disableClick": false,
            ...
            "gaEnableVisitorIndustry": true,
            "enableUAnalytics": true,
            "excludeUrls": ["*anantapurcity.com*"],
            "gaIndustrySlot": 1,
            "disablePoll": false,
            "arrowLeftPath": "/black_01.png",
            "jQueryVersion": "3.7.0",
            "sCatCtaIndNum": 62,
            "gaEnableCampaignPush": true,
            "excludedUrlsRecommendation": "not in [\"Thank_You%\"]",
            ...
            "barIconColor": "#ffffff",
            "uaEnableIndustryPush": true,
            "gaEnableSegmentPush": true
        };
        var campaignUrlData = "";
        ...
        var campaignStorage = new function() {
            var STORAGENAME = "it.cs",
                ...
                SESSION_ID = "sid",
                _this = this;
            trackObj = null, isCurrentSession = function(campaigns) {
        ...
        var getDomain = function(domain, domainLevel) {
            ...
            return splitedDomain != null ? splitedDomain[1] : (splitedDomain = /([^.]+\.[^.]+\.[^.]{2})$/i.exec(domain), splitedDomain != null ? splitedDomain[1] : domain)
        };
            ...
            switch (type) {
                ...
                case "wistia":
                    (function(type, iframeId, src) {
                        ...
                        if (wistiaEmbed) {
                            wistiaEmbed.on("play", function(src) {
                                return function() {
                                    AITag.sendClick(src, null, {
                                        yt: 1
                                    });
                ...
                if (targetDiv && targetDiv != "" && targetDiv != "widget" && (msg.useEffect != true && msg.useEffect != "true")) {
                    if (isReady) {
                        ...
                        if (!isInjected) {
                            ...
                            (!inzoneCampginTimoutSet && (new Date().getTime() - scriptExecutionTime < MAX_LOADING_TIME) && AITag.getConfig("campaignInjectionInterval") > 0) ? (inzoneCampaignTimeout = setTimeout(runAsyncQueue, runCounter == 0 ? 10 : AITag.getConfig("campaignInjectionInterval")), inzoneCampginTimoutSet = true) : false
                        }
                    }
                } else {
            ...
            $div.showDialogCallback = function() {
                ...
                try {
                    if (!AITag.getConfig("dialogCloseOnlyOnActualClose")) {
                        AITag.jQuery("body").on("click", function(e) {
        ...
        this.bindConversion = function(reactionId, requestId, $div) {
            ...
            if (campaignForms2.indexOf(reactionId) > -1) {
                ...
                $div.find("form").on("submit", function(event) {
                    var ajaxUrl = urlBase + "&cb=AITag.conversionCallback";
                    registerConversion(reactionId);
                    addDynamicScript(ajaxUrl)
                })
            }
            $div.find("a,:submit,:button").on("click", function(event) {
                var ajaxUrl = urlBase + "&cb=AITag.conversionCallback";
        ...
        this.bindEvent = function(element, eventType, eventFunction, extraParameter) {
            AITag.jQuery(element).on(eventType, eventFunction)
        };
        ...
        this.checkForEmailTextField = function() {
            ...
            var buttonNames = null,
                buttonName, buttonAttached = false;
            var emailField;
            ...
            if (fieldNames) {
                ...
                if (AITag.getConfig("getAllEmails")) {
                    ...
                    forms.each(function() {
                        AITag.jQuery(this).on("submit", function() {
...
if (!Object.keys) {
    ...
    function cz(cG, cE) {
        ...
        cF = /([^.]+\.[^.]{3,})$/i.exec(cG);
        return cF != null ? cF[1] : (cF = /([^.]+\.[^.]+\.[^.]{2})$/i.exec(cG), cF != null ? cF[1] : cG)
    }
