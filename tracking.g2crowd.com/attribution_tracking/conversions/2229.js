(t => {
    ...
    const n = "https://tracking-api.g2.com",
        i = "",
        e = "2229",
        o = "external",
        a = "",
        ...
        r = {
            ...
            setKey: function(t) {
                this.key = t.map((([t, n]) => n)).join(",").replace(/\s/g, "")
            },
            isFresh: function() {
    ...
    function f(n, i = "") {
        ...
        if (r.setKey(w), !r.isFresh()) {
            if (window.navigator && window.navigator.sendBeacon) {
                ...
                i.append("pid", a), i.append("p", t), i.append("s", o), w.forEach((([t, n]) => i.append(t, n))), window.navigator.sendBeacon(n, i)
    ...
    function h(t) {
        if (c) return !1;
        t ? (c = !0, f(`${n}/attribution_tracking/conversions/assign`, t)) : (g || (f(`${n}/attribution_tracking/conversions/assign`), g = !0), y())
    }

    function u() {
        if (c || w >= d) return f(`${n}/attribution_tracking/conversions/assign`);
        i || (f(`${n}/attribution_tracking/conversions/assign`), c = !0), window.ga && function(t, n) {
            let i;
            ! function(t, n) {
                for (let i = 0, e = t.length; i < e; i++) n(t[i])
            }(window.ga && window.ga.getAll && window.ga.getAll() || [], (function(n) {
                n.get("trackingId") === t && (i = n)
            })), n(!!i && i.get("clientId"))
        }(i, h), window.gtag && function(t, n) {
            window.gtag("get", t, "client_id", n)
        }(i, h), window.dataLayer && function(t, n) {
            window.dataLayer.push(["get", t, "client_id", n]), h("")
        }(i, h), window.gtag || window.ga || y()
    }
